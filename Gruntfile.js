...
module.exports = function (grunt) {
    ...
    if (process.argv[2] == 'rename') {
        ...
        if (!newname) {
            console.log('Please write the new fakeroku name, like: "grunt rename --name=mywidgetset" --author="Author Name"');
            process.exit();
        }
        ...
        if (fs.existsSync(__dirname + '/widgets/fakeroku/js/fakeroku.js')) {
            fs.renameSync(__dirname + '/widgets/fakeroku/js/fakeroku.js', __dirname + '/widgets/fakeroku/js/' + newname + '.js');
        }
